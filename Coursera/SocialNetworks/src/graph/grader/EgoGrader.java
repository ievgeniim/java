...
public class EgoGrader extends Grader {
    ...
    public void run() {
        try {
            ...
            GraphLoader.loadGraph(graph, "d:\\Git\\Coursera\\SocialNetworks\\data\\facebook_ucsd.txt");
            ...
            for (int i = 0; i < 10; i++) {
                ...
                BufferedReader br = new BufferedReader(new FileReader("d:\\Git\\Coursera\\SocialNetworks\\data\\ego_answers\\ego_" + i + ".txt"));
                String next;
